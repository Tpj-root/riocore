...
""",
    ...
    def generate(self, path):
        ...
        makefile_data.append('	@if [ $$? -eq 0 ]; then \')
        makefile_data.append('		echo "Load successful."; \')
        makefile_data.append('	else \')
        makefile_data.append('		echo "Load failed."; \')
        makefile_data.append('	fi')
        makefile_data.append("")
